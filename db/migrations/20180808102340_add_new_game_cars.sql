...
DROP PROCEDURE IF EXISTS add_new_game_cars $$

-- Create the stored procedure to perform the migration
CREATE PROCEDURE add_new_game_cars()

BEGIN

SET @last_migration_at = (SELECT last_migration_at FROM schema_version);
SET @migration_timestamp = TIMESTAMP('2018-08-08 10:23:40');
