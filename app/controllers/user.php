...
class User extends Front
{
    ...
    public function editUsername_action()
    {
        ...
        Model::editUserName(Request::post('user_name'));
    ...
    {
        Model::editUserEmail(Request::post('user_email'));
    ...
    public function editAvatar()
    {
        $this->View->render('user/editAvatar', array(
            'avatar_file_path' => Avatar::getPublicUserAvatarFilePathByUserId(Session::get('user_id'))
        ));
    }
    ...
    {
        Avatar::deleteAvatar(Session::get("user_id"));
        Redirect::to('user/editAvatar');
    }
