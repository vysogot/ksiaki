...
<body>
  ...
  <header>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/css/slick.css?v=<?= filemtime("assets/css/slick.css")?>" />
    <link rel="stylesheet" type="text/css" href="/assets/css/style.css?v=<?= filemtime("assets/css/style.css")?>" />

    <script src="/assets/js/jquery-1.11.0.min.js" type="text/javascript"></script>
    <script src="/assets/js/slick.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="/assets/js/sliders.js?v=<?= filemtime("assets/js/sliders.js")?>" type="text/javascript" charset="utf-8"></script>
    <script src="/assets/js/app.js?v=<?= filemtime("assets/js/app.js")?>" type="text/javascript" charset="utf-8"></script>
