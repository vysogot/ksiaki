...
class Login extends Front
{
    ...
    public function loginWithCookie()
    {
        // run the loginWithCookie() method in the login-model, put the result in $login_successful (true or false)
         $login_successful = Model::loginWithCookie(Request::cookie('remember_me'));
    ...
    {
        PasswordReset::requestPasswordReset(Request::post('user_name_or_email'), Request::post('captcha'));
        Redirect::to('login/index');
    }
    ...
    public function verifyPasswordReset($user_name, $verification_code)
    {
        ...
        if (PasswordReset::verifyPasswordReset($user_name, $verification_code)) {
