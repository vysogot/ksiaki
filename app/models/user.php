...
class User
{
    ...
    public static function getPublicProfilesOfAllUsers()
    {
        ...
        foreach ($users as $user) {
            ...
            // the user's values
            array_walk_recursive($user, 'Core\Filter::XSSFilter');
            ...
            $all_users_profiles[$user->user_id]->user_avatar_link = (Config::get('USE_GRAVATAR') ? Avatar::getGravatarLinkByEmail($user->user_email) : Avatar::getPublicAvatarFilePathOfUser($user->user_has_avatar, $user->user_id));
        }
    ...
    public static function getPublicProfileOfUser($user_id)
    {
        ...
        if (!empty($user)) {
            if (Config::get('USE_GRAVATAR')) {
                $user->user_avatar_link = Avatar::getGravatarLinkByEmail($user->user_email);
            } else {
                $user->user_avatar_link = Avatar::getPublicAvatarFilePathOfUser($user->user_has_avatar, $user->user_id);
            }
        } else {
    ...
    public static function editUserEmail($new_user_email)
    {
        ...
        if (self::saveNewEmailAddress(Session::get('user_id'), $new_user_email)) {
            ...
            Session::set('user_gravatar_image_url', Avatar::getGravatarLinkByEmail($new_user_email));
