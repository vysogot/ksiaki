...
class Login
{
    ...
    public static function loginWithCookie($cookie)
    {
        ...
        $result = User::getUserDataByUserIdAndToken($user_id, $token);
    ...
    public static function setSuccessfulLoginIntoSession($user_id, $user_name, $user_email, $user_account_type)
    {
        ...
        // get and set avatars
        Session::set('user_avatar_file', Avatar::getPublicUserAvatarFilePathByUserId($user_id));
        Session::set('user_gravatar_image_url', Avatar::getGravatarLinkByEmail($user_email));
