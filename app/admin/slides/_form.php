...
<form id="slide" action="<?= $params['form_action'] ?>" method="post" enctype="multipart/form-data">
  ...
  <div>
    ...
    <input id="is_active" type="checkslide" name="is_active" value="1" <?php if ($data->is_active == 1) echo "checked" ?> >
  </div>

</form>

<button type="submit" form="slide" value="Wyślij">Wyślij</button>
